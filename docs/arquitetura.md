...
| **B — `log-writer`** | Cliente JDBC Java 8 que a `LogPs` vai chamar; batching, tratamento de falha, benchmark contra o Oracle | implementado, 63 testes unitários verdes; conexão real já validada, gravação e benchmark aguardam ambiente |
