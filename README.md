...
|---|---|---|
| **B — `log-writer`** | Cliente JDBC (Java 8) que a `LogPs` vai chamar: batching, tratamento de falha, e o benchmark de escrita contra o Oracle | `log-writer/` — implementado, 64 testes verdes; ver `log-writer/README.md` |
